...
Namespace git tags by specId. Change tag format from `steel/<stage>-complete` to `steel/<specId>/<stage>-complete` to prevent tag collisions across specs.

## Specification to Review

Read the specification at: `specs/003-namespace-git-tags-by-specid/spec.md`
...
Use REVISE if there are any BLOCKING issues. Use APPROVE if there are no BLOCKING issues (warnings and notes alone do not block approval).
