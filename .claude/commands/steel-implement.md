...
3. **FOR EACH TASK** in `.steel/tasks.json`:
   ...
   **FORGE-GAUGE LOOP** (max iterations from config):
   ...
   b. Save implementation notes to `.steel/artifacts/implementation/forge-task<N>-iterM.md` including:
   ...
   g. Save the code review to `.steel/artifacts/implementation/gauge-task<N>-iterM.md`
