...
description: "Steel-Kit workflow skill: Generate a project constitution by analyzing the current codebase."
---
...
User prompt (optional): the user-provided input
...
4. Generate a constitution document with these sections based on your analysis:
   ...
   **## Constraints** — Hard constraints: performance budgets, compatibility targets, security requirements
   ...
   If the user provided a prompt in the user-provided input, incorporate their guidance into the constitution.
