---
name: steel-next
description: "Steel-Kit workflow skill: Run the next stage in the Steel-Kit workflow."
---

# steel-next

Use this skill when the user invokes `$steel-next` or asks to run the corresponding Steel-Kit workflow step in Codex.
